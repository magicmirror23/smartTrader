    ...
    <div class="page">
      ...
      <div *ngIf="results">
        ...
        <div class="card mb-2">
          ...
          <div class="grid-3">
            <div><span class="text-muted text-sm">Period:</span> {{ results.start_date }} â†’ {{ results.end_date }}</div>
        ...
        <div class="card">
          ...
          <div *ngIf="results.trades.length > tradesPerPage" class="flex justify-between items-center mt-2">
            ...
            <div class="flex gap-1">
              <button class="btn-sm" (click)="prevPage()" [disabled]="currentPage === 0">â† Prev</button>
              <button class="btn-sm" (click)="nextPage()" [disabled]="tradesEnd >= results.trades.length">Next â†’</button>
            </div>
          </div>
